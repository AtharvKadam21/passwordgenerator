...
function App() {
  ...
  const passwordGenerator = useCallback(() => { //memorizes the function for repeated calls
    let pass = "";
  ...
  useEffect(() => {
    passwordGenerator()
  }, [length, numAllow, charAllow, setPassword])//if password is also inclued in dependencies in [] goes into infinite loop. setPassword is used for optimization, memoization
  return (
